...
if(isset($_POST["submit"]))
  { 
    if($_POST['flag']=="lolape")
   {    
    $today=currentime();
    mysql_query("UPDATE userinfo SET q7='$today'
WHERE teamname='{$_SESSION['userid']}'");
	header('Location:gui8.php');
...
<p><a href="q7.php" target="_blank">GO FETCH THE FLAG</a></p>
     
<form action="gui7.php" method="POST">
    ...
    <ol>
     ...
     <?php
        ...
        if($user['q6']==0)
                ...
                echo " <li class='current' >"."Question 7"."</li>";
            echo " <div id='locked'>" ;
