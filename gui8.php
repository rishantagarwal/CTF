...
{ 
  ...
  var x=5;
  if(x==8)//change to false
    {window.location.href = 'gui9.php';}
  else{window.location.href = 'gui8.php';}
...
<form action="gui8.php" method="POST">
    <label for="ans-0">Enter the Flag :</label><input type="text" name="flag" id="codeDiv" id="TEXTBOX_ID"><br><br>
		

    
    
</div>
<div style="text-align:center"><button type="submit" onclick="doSomethingWithTextBox()" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false" name="submit"><span class="ui-button-text">Submit Answer!</span></button></div>
</form>
