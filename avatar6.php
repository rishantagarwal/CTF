...
<body data-twttr-rendered="true">
    <div id="header" >
        ...
        <div id="shareButtons">
		<table><tr><td><div id="avatartxt"><h1>Cr4ck</h1></div></td><td><div id="avatar" style="-webkit-mask-image:url('./avatar/crack.png');"></div></td></tr></table>
        </div>
    </div>

    <div id="main">
        <div id="content"><h1>The 'CRACK'</h1>
<div id="intro">
    
        <p>What else shall we say - there is very little you don‘t understand
and you can‘t fix in the virtual world. You are kind of a hacker
- you are an artist. You know how to digg deep into the details
of the cyber space. You are a trend setter, early adaptor to new
techniques and most likely involved in the latest research activities.

<h1 style="color:red;text-align:center;">We honor your status; Crack!</h1></p>
    
</div>

<p id="question" style="text-align:center"><img src="./avatar/crack.png"style="background-image:url('./Javascript Scope Quiz_files/bg.png');border-radius:5px;"/></p>
