...
<body data-twttr-rendered="true">
    <div id="header" >
        ...
        <div id="shareButtons">
		<table><tr><td><div id="avatartxt"><h1>NERD</h1></div></td><td><div id="avatar" style="-webkit-mask-image:url('./avatar/nerd.png');"></div></td></tr></table>
        </div>
    </div>

    <div id="main">
        <div id="content"><h1>The 'Nerd'</h1>
<div id="intro">
    
        <p>Hi Nerd! You have now reached the NERD status. Yeah - you
have solved more than some basic security challenges. We are
kind of impressed - don‘t be Evil and go one step further. Try to
become a GEEK!
<h1 style="color:red;text-align:center;">.... nice girls prefer geeks, not nerds ...</h1></p>
    
</div>

<p id="question" style="text-align:center"><img src="./avatar/nerd.png"style="background-image:url('./Javascript Scope Quiz_files/bg.png');border-radius:5px;"/></p>
