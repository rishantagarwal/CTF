...
<body data-twttr-rendered="true">
    <div id="header" >
        ...
        <div id="shareButtons">
		<table><tr><td ><div id="avatartxt"><h1>D0ngl3</h1></div></td><td><div id="avatar" style="-webkit-mask-image:url('./avatar/dongle.png');"></div></td></tr></table>
        </div>
    </div>

    <div id="main">
        <div id="content"><h1>The 'DONGLE'</h1>
<div id="intro">
    
        <p>If you have successfully solved some of the puzzles and
your solutions have been accepted by the jury, you will eventually
get DONGLE. You have not reached any kind of upper status
in the Race - but you showed up some basic skills.
<h1 style="color:red;text-align:center;">Try to become a NERD ...</h1></p>
    
</div>

<p id="question" style="text-align:center"><img src="./avatar/dongle.png"style="background-image:url('./Javascript Scope Quiz_files/bg.png');border-radius:5px;"/></p>
