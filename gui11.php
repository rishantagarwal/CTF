    ...
    <ol>
     ...
     <?php
        ...
        if($user['q6']==0)
		 ...
		 if($user['q8']==0)
				     {
     			   echo " <li class='no' >"."Question 8"."</li>";
                   }
				   else{echo " <li  class='yes' >"."Question 8"."</li>";}
			 if($user['q9']==0)
				     {
     			   echo " <li class='no' >"."Question 9"."</li>";
                   }
				   else{echo " <li  class='yes' >"."Question 9"."</li>";}
			 if($user['q9']==0)
				     {
     			   echo " <li class='no' >"."Question 10"."</li>";
                   }
				   else{echo " <li  class='yes' >"."Question 10"."</li>";}
                 echo " <li class='current'>"."Question 11"."</li>";
