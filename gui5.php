...
if(isset($_POST["submit"]))
  { 
   ...
   {    
$today=currentime();
mysql_query("UPDATE userinfo SET q5='$today'
WHERE teamname='{$_SESSION['userid']}'");
	header('Location:gui6.php');
   }
...
<p><a href="q5.php" target="_blank">GO FETCH THE FLAG</a></p>
     
<form action="gui5.php" method="POST">
    ...
    <ol>
     ...
     <?php
           ...
           if($user['q4']==0)
            ...
            echo " <li class='current'>"."Question 5"."</li>";
			echo " <div id='locked'>" ;
